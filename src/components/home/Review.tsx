			...
			<div className='max-w-300 mx-auto px-8 md:px-12'>
				...
				<div className='bg-navy-2 border border-white/13 rounded-2xl p-10 md:p-14 max-w-[800px] mx-auto text-center'>
					...
					<blockquote className='text-lg md:text-xl text-[#EEF2FF] leading-relaxed italic mb-8'>
						«У меня небольшой магазин бьюти-товаров, и мне
						понадобилось оборудование. Обратилась в Интех-Софт — мне
						посоветовали терминал Эвотор. Оказалось очень выгодно и
						удобно. Всё объяснили, настроили и сразу помогли
						разобраться. Рекомендую!»
					</blockquote>
