...
const faqs = [
	{
		q: 'Кому подойдут курсы?',
		a: 'Курсы подойдут бухгалтерам, менеджерам, HR-специалистам, предпринимателям и начинающим пользователям. Есть программы с нуля и для повышения квалификации.',
	},
	{
		q: 'Можно ли обучить сотрудников компании?',
		a: 'Да. Проводим корпоративное обучение с учётом специфики бизнеса и задач вашей компании.',
	},
	{
		q: 'Вы обучаете программированию 1С?',
		a: 'Да, обучаем. Есть курсы по разработке и доработке решений на платформе 1С для начинающих и специалистов.',
	},
	{
		q: 'Где находится учебный центр?',
		a: 'Учебный центр находится по адресу: ул. Имама Шамиля, 5.',
	},
	{
		q: 'Как выбрать подходящий курс?',
		a: 'Поможем подобрать курс под вашу задачу — для работы, повышения квалификации или старта в новой профессии.',
	},
]
