const courses = [
	...
	},
	{
		...
		duration: '30 часов',
		format: 'Очно / Онлайн',
		desc: 'Курс для тех, кто хочет научиться уверенно работать на компьютере. Освоение Windows, работа с файлами и папками, создание и оформление документов в Word, расчёты и таблицы в Excel, поиск информации в Интернете и использование электронной почты.',
		topics: [
			'Устройство компьютера и работа в Windows',
			'Работа с файлами, папками, поиск и архивирование',
			'Интернет и электронная почта',
			'Профессиональная работа в Word: документы, таблицы и оформление',
			'Основы работы в Excel: ячейки, листы и вычисления',
			'Продвинутые возможности Excel: функции, сортировка, фильтры и диаграммы',
		],
	},
]
