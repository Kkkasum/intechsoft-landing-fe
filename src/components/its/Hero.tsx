...
const benefits = [
	{ icon: '🔄', label: 'Актуальные обновления конфигураций' },
	{ icon: '🛡️', label: 'Официальные ресурсы и сервисы' },
	{ icon: '💬', label: 'Круглосуточная поддержка' },
	{ icon: '📞', label: 'Консультационная линия' },
]
