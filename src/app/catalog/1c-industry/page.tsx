...
import { industryCatalog } from '@/src/content/catalog'
import { ROUTE_HOME } from '@/src/routes'
import Link from 'next/link'
import { useState } from 'react'

export default function Industry1CPage() {
	const [activeCat, setActiveCat] = useState(industryCatalog[0].id)
	const [activeSubcat, setActiveSubcat] = useState('all')

	const category = industryCatalog.find(c => c.id === activeCat)!
